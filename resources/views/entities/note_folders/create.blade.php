        ...
        <div class="col-md-6 m-0auto">
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Добавить папку заметок</h3>
                ...
                <div class="block-content">
                    <form action="{{ route('note_folders.notes.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="mb-16">
                                    <input type="text" class="form-control" id="title" name="title" placeholder="Название.."  maxlength="255">
                                </div>
                                @error('title')
