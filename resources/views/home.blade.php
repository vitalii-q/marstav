    ...
    <div class="row">
        <div class="col-lg-12">
            <div id="workspace" class="block workspace">
                <ul id="tabs_ul" class="nav nav-tabs nav-tabs-block align-items-center" data-toggle="tabs" role="tablist">
                    @php($i=1) @foreach($notes as $note)
                    <li id="tab_button_{{ $note->code }}" class="nav-item">
                        <a href="#tab_pane_{{ $note->code }}" class="nav-link @if($i==1) active @endif">
                ...
                <div id="tab_content" class="block-content tab-content">
                    ...
                    @php($i=1) @foreach($notes as $note)
                    <div class="tab-pane @if($i==1) active @endif" id="tab_pane_{{ $note->code }}" role="tabpanel">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="form-material">
                                                    <input type="text" class="form-control" id="ws_add_note_title" name="ws_add_note" placeholder="Введите название" maxlength="255">
